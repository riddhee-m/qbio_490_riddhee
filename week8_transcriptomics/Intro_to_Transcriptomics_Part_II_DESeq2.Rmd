...
rna_counts <- read.csv("/Users/riddheemehta/Desktop/Code/QBIO/qbio_490_riddhee/analysis_data/brca_rna_count_data.csv")
rna_genes <- read.csv("/Users/riddheemehta/Desktop/Code/QBIO/qbio_490_riddhee/analysis_data/brca_rna_gene_data.csv")
rna_clinical <- read.csv("/Users/riddheemehta/Desktop/Code/QBIO/qbio_490_riddhee/analysis_data/brca_rna_clinical_data.csv")
```
...
# does the mask go in the same or opposite location?
```
...
Gene ensembl id: ENSG00000135413.9
Log2FoldChange: 3.439198
p-adj value: 1.308574e-27	
...
Lacritin, modulates secretion by lacrimal acinar cells.

Gene ensembl id: ENSG00000167531.6
Log2FoldChange: -2.828931	
p-adj value: 1.525081e-14	
More highly expressed in young or old patients: young patients
Google the gene. What is its full name, and what appears to be its function? Genecards generally has a pretty good summary:
Lactalbumin Alpha, changes the substrate specificity of galactosyltransferase in the mammary gland making glucose a good acceptor substrate for this enzyme.

Write the results, up_reg_results, and down_reg_results df's to analysis_data using write.csv().

```{r}
# write code here
write.csv(results, "/Users/riddheemehta/Desktop/Code/QBIO/qbio_490_riddhee/analysis_data/results.csv", row.names = TRUE)
write.csv(up_reg_results, "/Users/riddheemehta/Desktop/Code/QBIO/qbio_490_riddhee/analysis_data/up_reg_results.csv", row.names = TRUE)
write.csv(down_reg_results, "/Users/riddheemehta/Desktop/Code/QBIO/qbio_490_riddhee/analysis_data/down_reg_results.csv", row.names = TRUE)
```
...
EnhancedVolcano(results, 
                ...
                x = "Log2 Fold Change", 
                y = "PAdj",
                title = "Gene Expression in Old Patients",
                pointSize = 3.0,
                labSize = 6.0,
                col=c('black', 'black', 'black', 'red3'),
                colAlpha = 1)

ggsave("/Users/riddheemehta/Desktop/Code/QBIO/qbio_490_riddhee/week8_transcriptomics/volcano_plot.png")
```

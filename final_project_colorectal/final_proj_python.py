...
write.csv(clinic_coad_tcga, "tcga_coad_clinical_data.csv", row.names = T)
write.csv(rna_genes_coad_tcga, "tcga_coad_rna_gene_data.csv", row.names = T)
write.csv(rna_counts_coad_tcga, "tcga_rna_count_data.csv", row.names = TRUE)
